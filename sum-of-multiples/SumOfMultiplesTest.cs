...
public class SumOfMultiplesTest
{
    ...
    {
        Assert.Equal(0, SumOfMultiples.Sum(new[] { 3 }, 1));
    }

    [Fact]
    public void Multiples_of_3_or_5_up_to_4()
    {
        Assert.Equal(3, SumOfMultiples.Sum(new[] { 3 }, 4));
    }

    [Fact]
    public void Multiples_of_3_or_5_up_to_7()
    {
        Assert.Equal(6, SumOfMultiples.Sum(new[] { 3 }, 7));
    }
